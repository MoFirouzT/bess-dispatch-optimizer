...
- [x] `formulation-r2.md` §R2.6 (the delta above) plus a changelog entry, and the release split it required (decision 5). The §R1.1 correction separating price impact from price contingency landed with it.
