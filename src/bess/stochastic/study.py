...
# --------------------------------------------------------------------------- R2.6
# Bid-curve value: does a price-contingent commitment earn more realized euros than
# a single blind schedule, and at what recourse budget does the edge disappear?
# (spec R2.6; formulation-r2 § R2.6, evaluation semantics)
